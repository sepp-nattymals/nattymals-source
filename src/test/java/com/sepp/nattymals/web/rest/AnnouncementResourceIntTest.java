...
public class AnnouncementResourceIntTest {
    ...
    public void initTest() {
        ...
        announcement.setTitle(DEFAULT_TITLE);
        announcement.setCompanyName(DEFAULT_COMPANY_NAME);
        announcement.setStartDate(DEFAULT_START_DATE);
        announcement.setEndDate(DEFAULT_END_DATE);
        announcement.setPhoto(DEFAULT_PHOTO);
        announcement.setPhotoContentType(DEFAULT_PHOTO_CONTENT_TYPE);
    }
    ...
    public void createAnnouncement() throws Exception {
        ...
        assertThat(testAnnouncement.getCompanyName()).isEqualTo(DEFAULT_COMPANY_NAME);
        ...
        assertThat(testAnnouncement.getPhoto()).isEqualTo(DEFAULT_PHOTO);
        assertThat(testAnnouncement.getPhotoContentType()).isEqualTo(DEFAULT_PHOTO_CONTENT_TYPE);
    }
    ...
    public void updateAnnouncement() throws Exception {
        ...
        announcement.setTitle(UPDATED_TITLE);
        announcement.setCompanyName(UPDATED_COMPANY_NAME);
        announcement.setStartDate(UPDATED_START_DATE);
        announcement.setEndDate(UPDATED_END_DATE);
        announcement.setPhoto(UPDATED_PHOTO);
        announcement.setPhotoContentType(UPDATED_PHOTO_CONTENT_TYPE);
        ...
        assertThat(testAnnouncement.getCompanyName()).isEqualTo(UPDATED_COMPANY_NAME);
        ...
        assertThat(testAnnouncement.getPhoto()).isEqualTo(UPDATED_PHOTO);
        assertThat(testAnnouncement.getPhotoContentType()).isEqualTo(UPDATED_PHOTO_CONTENT_TYPE);
    }
